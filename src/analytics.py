...
class Reporter:
    ...
    def print_overall_report(self):
        ...
        print("Push Count: {}".format(self.total_game_count - (self.win_count + self.lose_count)))
        print("Win Percentage: {}".format(self.win_count / self.total_game_count))
        print("Lose Percentage: {}".format(self.lose_count / self.total_game_count))
